...
def register_blueprints(app):
    ...
    from faraday.server.api.modules.param_type import param_type_validate  # pylint:disable=import-outside-toplevel
    ...
    app.register_blueprint(param_type_validate)
