...
def initdb_roles_and_permissions(db_engine):
    try:
        ...
        db_engine.execute(  # nosec
            ...
            f"(44, '{UNIT_CREDENTIALS}', 15), (45, '{UNIT_CONFIG}', 2), (46, '{UNIT_WEBSOCKETS}', 2), (48, '{UNIT_BASE}', 1), (49, '{UNIT_ADMIN}', 1), (50, '{UNIT_ROLES}', 1), (51, '{UNIT_WS_SUM_REPORTS}', 17);"  # nosec B608
        )
        ...
        db_engine.execute(  # nosec
            ...
            f"(158, '{UPDATE}', 50), (159, '{DELETE}', 50), (160, '{CREATE}', 51), (161, '{READ}', 51), "  # nosec B608
            f"(162, '{UPDATE}', 51), (163, '{DELETE}', 51);"  # nosec B608
        )
        ...
        db_engine.execute(
            ...
            "(191, 69, 2, false), (192, 70, 2, true), (193, 71, 2, true), (194, 72, 2, true), "
            "(195, 73, 2, true), (196, 74, 2, false), (197, 75, 2, true), (198, 76, 2, false), "
            "(199, 77, 2, false), (200, 78, 2, false), (201, 79, 2, true), (202, 80, 2, false), "
            "(203, 81, 2, false), (204, 82, 2, true), (205, 83, 2, true), (206, 84, 2, true), "
            "(207, 85, 2, false), (208, 86, 2, true), (209, 87, 2, true), (210, 88, 2, true), "
            "(211, 89, 2, true), (212, 90, 2, true), (213, 91, 2, true), (214, 92, 2, true), "
        ...
        db_engine.execute(
            ...
            "(634, 157, 4, false), (635, 158, 4, false), (636, 159, 4, false), (649, 160, 4, true), "
            "(650, 161, 4, true), (651, 162, 4, true), (652, 163, 4, true);"
        )
