...
class DnsenumXmlParser(object):
    ...
    """
    def __init__(self, dnsenum_xml_filepath):
        self.filepath = dnsenum_xml_filepath
...
class DnsenumPlugin(core.PluginBase):
    ...
    def parseOutputString(self, output, debug = False):
        ...
        if debug:
            ...
            parser = DnsenumXmlParser(self._xml_output_path)
    ...
    def processCommandString(self, username, current_path, command_string):
        ...
        if arg_match is None:
            return re.sub(r"(^.*?dnsenum(\.pl)?)",r"\1 -o %s" % self._xml_output_path,command_string)
        else:
            return re.sub(arg_match.group(1),
                          r"-o %s" % self._xml_output_path,
                          command_string)
