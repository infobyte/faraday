...
class DnsreconXmlParser(object):
    ...
    """
    def __init__(self, dnsrecon_xml_filepath):
        self.filepath = dnsrecon_xml_filepath
...
class DnsreconPlugin(core.PluginBase):
    ...
    def parseOutputString(self, output, debug = False):
        ...
        if debug:
            ...
            parser = DnsreconXmlParser(self._xml_output_path)
    ...
    def processCommandString(self, username, current_path, command_string):
        ...
        if arg_match is None:
            return re.sub(r"(^.*?dnsrecon(\.py)?)",
                          r"\1 --xml %s" % self._xml_output_path,
                          command_string)
        else:
            return re.sub(arg_match.group(1),
                          r"--xml %s" % self._xml_output_path,
                          command_string)
