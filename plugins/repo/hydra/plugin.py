...
class HydraParser(object):
    ...
    """
    def __init__(self, hydra_filepath):
        self.filepath = hydra_filepath
...
class HydraPlugin(core.PluginBase):
    ...
    def parseOutputString(self, output, debug = False):
        ...
        if debug:
            ...
            parser = HydraParser(self.output_path)
    ...
    def processCommandString(self, username, current_path, command_string):
        ...
        self.output_path=os.path.join(self.data_path,"hydra_output-%s.txt" % random.uniform(1,10))        
        arg_match = self.xml_arg_re.match(command_string)

        if arg_match is None:
            return re.sub(r"(^.*?hydra?)",r"\1 -o %s" % self.output_path,command_string)
        else:
