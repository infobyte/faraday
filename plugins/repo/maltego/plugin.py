...
class MaltegoMtgxParser():
    ...
    def getWebsite(self, target_node):
        ...
        for prop in props:
            ...
            value = prop.find("{http://maltego.paterva.com/xml/mtgx}Value").text
    ...
    def getLocation(self, target_node):
        ...
        result = {"name" : "", "area": "" , "country_code": "",
                    "longitude" : "", "latitude" : "", "area_2" : ""
                 }
...
class MaltegoPlugin(core.PluginBase):
     ...
     def parseOutputString(self, output, debug = False):
         ...
         maltego_parser = MaltegoMtgxParser(self.report)
     ...
     def processCommandString(self, username, current_path, command_string):
         ...
         report = command_string.split("maltego_faraday ")[1]
         self.report = os.path.join(current_path, report)
