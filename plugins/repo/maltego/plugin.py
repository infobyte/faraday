...
class MaltegoXmlParser(object):
    ...
    """
    def __init__(self, maltego_xml_filepath):
        self.filepath = maltego_xml_filepath
        self.target = None
        self.port = "80"
        self.host = None
...
class MaltegoPlugin(core.PluginBase):
    ...
    def parseOutputString(self, output, debug = False):
        ...
        self._xml_output_path = "/root/tools/maltego/Graphs/Graph1.graphml"
        ...
        if debug:
            ...
            parser = MaltegoXmlParser(self._xml_output_path)
