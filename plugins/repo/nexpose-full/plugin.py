...
class NexposeFullPlugin(core.PluginBase):
    ...
    def parseOutputString(self, output, debug = False):
        ...
        for item in parser.items:
            ...
            i_id = self.createAndAddInterface(h_id, item['name'], ipv4_address = item['name'], hostname_resolution = item['hostnames'])

            for v in item['vulns']:
                v_id = self.createAndAddVulnToHost(h_id, v['name'], v['desc'], v['refs'], v['severity'], v['resolution'])
            ...
            for s in item['services']:
                ...
                s_id = self.createAndAddServiceToInterface(h_id, i_id, s['name'],
                                                    ...
                                                    version = version)
                for v in s['vulns']:
                    v_id = self.createAndAddVulnToService(h_id, s_id, v['name'], v['desc'], v['refs'], v['severity'], v['resolution'])
        del parser
