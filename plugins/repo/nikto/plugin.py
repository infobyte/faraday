...
class NiktoXmlParser(object):
    ...
    """
    def __init__(self, nikto_xml_filepath):
        self.filepath = nikto_xml_filepath
...
class NiktoPlugin(core.PluginBase):
    ...
    def parseOutputString(self, output, debug = False ):
        ...
        parser = NiktoXmlParser(self._xml_output_path)
        ...
        if not debug and not self._xml_output_path == output :
    ...
    def processCommandString(self, username, current_path, command_string):
        ...
        if arg_match is None:
            return re.sub(r"(^.*?nikto(\.pl)?)",
                          r"\1 -output %s -Format XML" % self._xml_output_path,
                          command_string)
        else:
            data=re.sub(" \-Format XML","",command_string)
            return re.sub(arg_match.group(1),
                          r"-output %s -Format XML" % self._xml_output_path,
                          data)
