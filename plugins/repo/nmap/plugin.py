...
class NmapXmlParser(object):
    ...
    """
    def __init__(self, nmap_xml_filepath):
        self.filepath = nmap_xml_filepath
...
class NmapPlugin(core.PluginBase):
    ...
    def parseOutputString(self, output, debug = False):
        ...
        if debug:
            ...
            parser = NmapXmlParser(self._xml_output_path)
        ...
        if not debug:
            os.remove(self._xml_output_path)
    ...
    def processCommandString(self, username, current_path, command_string):
        ...
        user has set.
        """
        self._xml_output_path=os.path.join(self.data_path,"nmap_output-%s.xml" % random.uniform(1,10))        
        ...
        if arg_match is None:
            return re.sub(r"(^.*?nmap)",
                          r"\1 -oX %s" % self._xml_output_path,
                          command_string)
        else:
            return re.sub(arg_match.group(1),
                          r"-oX %s" % self._xml_output_path,
                          command_string)
