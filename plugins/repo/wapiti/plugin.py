...
class WapitiXmlParser(object):
    ...
    """
    def __init__(self, wapiti_xml_filepath):
        self.filepath = wapiti_xml_filepath
...
class WapitiPlugin(core.PluginBase):
    ...
    def parseOutputString(self, output, debug = False):
        ...
        self._xml_output_path="/root/dev/faraday/trunk/src/report/wapiti2.3.0_abaco.xml"
        if debug:
            ...
            parser = WapitiXmlParser(self._xml_output_path)
    ...
    def processCommandString(self, username, current_path, command_string):
        ...
        return "%s -o %s -f xml \n" % (command_string,self._xml_output_path)
