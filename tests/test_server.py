...
class TestAuthentication(BaseAPITestCase, unittest.TestCase):
    ...
    def test_401_when_getting_an_existent_view_agent_token(self):
        res = self.app.get('/_api/v3/ws/', headers={'authorization': 'agent 1234'})
        self.assertEqual(res.status_code, 401)
    ...
    @pytest.mark.skip(reason="Could not make it work. We should see this later.")
